...
// Command iso4217gen regenerates engine/tables/currency_data.go from the
...
//
//	curl -o engine/tables/generate/iso4217/list-one.xml \
//	  https://www.six-group.com/dam/download/financial-information/data-center/iso-currrency/lists/list-one.xml
//	go run engine/tables/generate/iso4217/main.go
//
...
// engine/) must never do. Run it explicitly with `go run`, not `go build
// ./...` or `go test ./...`.
package main
...
const (
	sourcePath = "engine/tables/generate/iso4217/list-one.xml"
	outputPath = "engine/tables/currency_data.go"
)
...
func renderSource(pblshd, version string, rows []row) ([]byte, error) {
	...
	fmt.Fprintf(&b, "// Code generated by `go run engine/tables/generate/iso4217/main.go`. DO NOT EDIT.\n")
	fmt.Fprintf(&b, "//\n")
	...
	fmt.Fprintf(&b, "// SIX Group. Committed snapshot: engine/tables/generate/iso4217/list-one.xml.\n")
