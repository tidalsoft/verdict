...
// Command iso4217gen regenerates verdict/tables/currency_data.go from the
...
//
//	curl -o verdict/tables/generate/iso4217/list-one.xml \
//	  https://www.six-group.com/dam/download/financial-information/data-center/iso-currrency/lists/list-one.xml
//	go run verdict/tables/generate/iso4217/main.go
//
...
const (
	sourcePath = "verdict/tables/generate/iso4217/list-one.xml"
	outputPath = "verdict/tables/currency_data.go"
)
...
func renderSource(pblshd, version string, rows []row) ([]byte, error) {
	...
	fmt.Fprintf(&b, "// Code generated by `go run verdict/tables/generate/iso4217/main.go`. DO NOT EDIT.\n")
	fmt.Fprintf(&b, "//\n")
	...
	fmt.Fprintf(&b, "// SIX Group. Committed snapshot: verdict/tables/generate/iso4217/list-one.xml.\n")
