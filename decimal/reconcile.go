...
// is empty. MU-12 (total_reconciliation) needs the sum of an
...
// arithmetic. This is MU-12's own comparison — "compute sum(...) in
// exact decimal arithmetic[;] difference from total exceeding tolerance
// fails." Money never passes through float64: reconciling line items
// [0.1, 0.2] to a total of 0.3 passes only because this comparison never
// converts through float64.
//
// tolerance is typically the exact zero Decimal (MU-12's documented
